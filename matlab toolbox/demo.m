...
HOMEIMAGES = '/Users/lingevan/Desktop/FYP/training annotation/ulabel/Images'; % you can set here your default folder
HOMEANNOTATIONS = '/Users/lingevan/Desktop/FYP/training annotation/ulabel/Annotations'; % you can set here your default folder

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% PART 1) MANIPULATION OF INDIVIDUAL FILES:

% select one annotation file from one of the folders:
filename = fullfile(HOMEANNOTATIONS, 'example_folder', 'img1.xml');
